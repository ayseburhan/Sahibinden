...
import 'package:kullanici_giris/productScreen/productdetail/sporDetailPage.dart';
...
class _SporPageState extends State<SporPage> {
  ...
  void initState() {
    super.initState();
    fetchUrunlerByKategoriId(5);
  }

  Future<void> fetchUrunlerByKategoriId(int kategoriId) async {
    final response = await http.get(
        Uri.parse('${Urls.BASE_URL}/GetUrunlerByKategoriId?kategoriId=$kategoriId'));
    ...
    return MainScaffold(
      child: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 31, 115, 212),
        ),
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SporDetayPage(ilan: ilan),
                        ),
                      );
                    },
                    child: Card(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    color: Color.fromARGB(255, 31, 115, 212),
                                  ),
                                ),
                              ],
                            ),
